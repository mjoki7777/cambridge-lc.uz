    ...
    render() {    
        ...
        return (
            <div className='background' >
              ...
              <div className="runningline">
              <b> Благотворительные мероприятия &nbsp; </b> &nbsp; Мастер-классы
              </div>
              ...
              <Carousel autoplay className="mainrunning2 runningline">
              <div>
              Speaking Club
              </div>
              <div>
              ...
              <Carousel autoplay effect="fade" className="mainrunning2 runningline showw">
              <div>
              <img className="runningimages" src={'222.jpg'} alt="222"></img>
              </div>
              <div>
